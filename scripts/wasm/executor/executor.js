...
import { nowMs } from 'host:interfaces/clock';
import { call } from 'host:interfaces/http-with-placeholders';
import { error, info } from 'host:interfaces/logging';
import { sign } from 'host:interfaces/signing';
import { tenantDid } from 'host:tenant/tenant-context';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./executor.core.wasm', import.meta.url));
